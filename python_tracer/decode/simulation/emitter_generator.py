...
class EmitterSampler(ABC):
    ...
    def __call__(self) -> emitter.EmitterSet:
        return self.sample()

    @abstractmethod
    def sample(self) -> emitter.EmitterSet:
...
class EmitterSamplerFrameIndependent(EmitterSampler):
    ...
    def sample_n(self, n: int) -> emitter.EmitterSet:
        """
        ...
        return emitter.EmitterSet(xyz=xyz, phot=phot,
...
class EmitterSamplerBlinking(EmitterSamplerFrameIndependent):
    ...
    def sample_loose_emitter(self, n) -> emitter.LooseEmitterSet:
        """
        ...
        return emitter.LooseEmitterSet(xyz, intensity, ontime, t0, id=torch.arange(n).long(),
