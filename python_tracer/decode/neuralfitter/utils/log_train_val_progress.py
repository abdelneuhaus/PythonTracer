...
import python_tracer.decode.generic.emitter
from python_tracer.decode.evaluation.evaluation import WeightedErrors
from python_tracer.decode.evaluation import predict_dist
from python_tracer.decode.plot import frame_coord

from python_tracer.decode.evaluation import evaluation
...
def log_frames(x, y_out, y_tar, weight, em_out, em_tar, tp, tp_match, logger, step, colorbar=True):
    ...
    assert isinstance(em_tar, python_tracer.decode.generic.emitter.EmitterSet)
