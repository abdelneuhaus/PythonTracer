...
import python_tracer.decode.simulation.background
from python_tracer.decode.evaluation import match_emittersets
from python_tracer.decode.generic.emitter import EmitterSet, EmptyEmitterSet
from .utils.probability import binom_pdiverse
...
class ConsistencyPostprocessing(PostProcessing):
    ...
    def __init__(self, *, raw_th, em_th, xy_unit: str, img_shape, ax_th=None, vol_th=None, lat_th=None,
        ...
        self._bg_calculator = python_tracer.decode.simulation.background.BgPerEmitterFromBgFrame(filter_size=13, xextent=(0., 1.),
                                                                                   yextent=(0., 1.),
                                                                                   img_shape=img_shape)
